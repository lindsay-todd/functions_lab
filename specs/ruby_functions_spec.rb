...
class FunctionsTest < MiniTest::Test
  ...
  def test_volume_of_cube()
    volume_of_side_3_cube = volume_of_cube(3)
    assert_equal(27, volume_of_side_3_cube)
  end

  #Given the radius of a sphere calculate the volume
  def test_volume_of_sphere()
    volume_of_sphere_radius_3 = volume_of_sphere(3)
    assert_equal((4.0 / 3.0) * Math::PI * 27, volume_of_sphere_radius_3)
  end

  #Given a value in farenheit, convert this into celsius.
  def test_fahrenheit_to_celsius()
    fahrenheit_86 = fahrenheit_to_celsius(86)
    assert_equal(30, fahrenheit_86)
  end
